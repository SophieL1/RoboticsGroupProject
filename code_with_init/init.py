            ...
            if img is not None:
                ...
                if corner_coordinates is not None: #if we had get the coordinates
                    ...
                    if pos_goal is not None:
                        ...
                        my_coordinates, expanded_obs = findPath(pos_obstacle, pos_thymio, robot_dir0, pos_goal, width, width_goal, thymio_dimensions, xlim= 850, ylim=800, verbose=True)
                        return my_coordinates, expanded_obs, cam, corner_coordinates
